...
//start accept-read-write-close loop for concurrent get:
//jmp concurrent_get
//concurrent_get:
        ...
        syscall
        //jmp concurrent_get
        //end accept-read-write-close loop
        //accept
        mov rdi, 3
        mov rsi, 0
        mov rdx, 0
        mov rax, 43
        syscall
        // I'm not sure what happens here. There's no loop, so the parent isn't going back?
